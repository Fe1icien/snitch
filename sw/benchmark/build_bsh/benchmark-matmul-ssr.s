...
/home/bsc22f7/scratch/snitch/sw/benchmark/build_bsh/benchmark-matmul-ssr:	file format elf32-littleriscv

Sections:
Idx Name              Size     VMA      Type
  0                   00000000 00000000 
  1 .text             00002924 80000000 TEXT
  2 .init             00000468 80002930 TEXT
  3 .rodata           000002b8 80002d98 DATA
  4 .tdata            00000000 80003050 DATA
  5 .tbss             00000010 80003050 BSS
  6 .tbssend          00000000 80003060 DATA
  7 .sdata            000000c0 80003060 DATA
  8 .data             00000000 80003120 DATA
  9 .sbss             00000004 80003120 BSS
 10 .bss              00000000 80003124 BSS
 11 .dram             00000000 80003124 DATA
 12 .debug_info       000037d1 00000000 
 13 .debug_abbrev     00000d43 00000000 
 14 .debug_aranges    00000040 00000000 
 15 .debug_line       00002f62 00000000 
 16 .debug_str        00000d68 00000000 
 17 .comment          000000bf 00000000 
 18 .riscv.attributes 00000037 00000000 
 19 .debug_frame      00000388 00000000 
 20 .debug_loc        00003194 00000000 
 21 .debug_ranges     00000468 00000000 
 22 .symtab           00003670 00000000 
 23 .shstrtab         000000e4 00000000 
 24 .strtab           0000095d 00000000 
...
80000674: 13 05 d5 7b  	addi	a0, a0, 1981
...
800007e4: 13 06 46 66  	addi	a2, a2, 1636
...
8000092c: 13 06 06 56  	addi	a2, a2, 1376
...
80000998: 13 06 c6 51  	addi	a2, a2, 1308
...
8000137c: 93 84 84 ce  	addi	s1, s1, -792
...
80001498: 13 05 45 bd  	addi	a0, a0, -1068
...
80001518: 13 0c bc 92  	addi	s8, s8, -1749
...
8000163c: 93 85 85 9c  	addi	a1, a1, -1592
...
8000165c: 13 05 85 a2  	addi	a0, a0, -1496
...
80001a54: 93 84 84 63  	addi	s1, s1, 1592
80001a58: 87 b0 04 00  	fld	ft1, 0(s1)

80001a5c <.LBB5_44>:
80001a5c: 97 14 00 00  	auipc	s1, 1
80001a60: 93 84 44 63  	addi	s1, s1, 1588
...
80001b40: 93 85 c5 55  	addi	a1, a1, 1372
80001b44: 07 b1 05 00  	fld	ft2, 0(a1)

80001b48 <.LBB5_46>:
80001b48: 97 15 00 00  	auipc	a1, 1
80001b4c: 93 85 85 55  	addi	a1, a1, 1368
...
80001b9c: 13 06 86 52  	addi	a2, a2, 1320
80001ba0: 87 31 06 00  	fld	ft3, 0(a2)

80001ba4 <.LBB5_51>:
80001ba4: 17 16 00 00  	auipc	a2, 1
80001ba8: 13 06 46 52  	addi	a2, a2, 1316
...
80001bd8: 13 06 46 50  	addi	a2, a2, 1284
80001bdc: 87 31 06 00  	fld	ft3, 0(a2)

80001be0 <.LBB5_53>:
80001be0: 17 16 00 00  	auipc	a2, 1
80001be4: 13 06 06 50  	addi	a2, a2, 1280
...
80001bf4: 13 06 06 4e  	addi	a2, a2, 1248
...
80001c04: 13 06 86 4e  	addi	a2, a2, 1256
...
80001c38: 93 86 c6 4b  	addi	a3, a3, 1212
...
80001c6c: 93 85 05 49  	addi	a1, a1, 1168
80001c70: 07 b1 05 00  	fld	ft2, 0(a1)

80001c74 <.LBB5_58>:
80001c74: 97 15 00 00  	auipc	a1, 1
80001c78: 93 85 c5 48  	addi	a1, a1, 1164
...
80002314: e7 80 00 a2  	jalr	-1504(ra)
...
80002344: 93 84 84 a5  	addi	s1, s1, -1448
...
80002388: 93 86 c6 d8  	addi	a3, a3, -628
8000238c: 07 b0 06 00  	fld	ft0, 0(a3)

80002390 <.LBB0_24>:
80002390: 97 16 00 00  	auipc	a3, 1
80002394: 93 86 86 d7  	addi	a3, a3, -648
...
800023c4: e7 80 00 97  	jalr	-1680(ra)
800023c8: 97 10 00 00  	auipc	ra, 1
800023cc: e7 80 80 96  	jalr	-1688(ra)
...
800023e8: 93 86 46 d2  	addi	a3, a3, -732
...
80002420: 93 86 c6 ce  	addi	a3, a3, -788
...
8000246c: e7 80 80 8c  	jalr	-1848(ra)
; size_t benchmark_get_cycle() { return read_csr(mcycle); }
...
800024a8: e7 80 c0 88  	jalr	-1908(ra)
; size_t benchmark_get_cycle() { return read_csr(mcycle); }
...
800024e0: 93 87 c7 c3  	addi	a5, a5, -964
...
800024f4: 13 04 04 8b  	addi	s0, s0, -1872
...
800025b0: 93 d2 25 00  	srli	t0, a1, 2
;     --b0;
800025b4: 13 03 f6 ff  	addi	t1, a2, -1
;     --b1;
800025b8: 93 82 f2 ff  	addi	t0, t0, -1
;     --b2;
800025bc: 93 03 f5 ff  	addi	t2, a0, -1
800025c0: 37 5e 20 00  	lui	t3, 517
;     ssr_config_reg[dm].bounds[0].value = b0;
800025c4: 23 28 6e 80  	sw	t1, -2032(t3)
;     ssr_config_reg[dm].bounds[1].value = b1;
800025c8: 23 2c 5e 80  	sw	t0, -2024(t3)
;     ssr_config_reg[dm].bounds[2].value = b2;
800025cc: 23 20 7e 82  	sw	t2, -2016(t3)
800025d0: 93 0e 80 00  	addi	t4, zero, 8
;     ssr_config_reg[dm].stride[0].value = i0 - a;
800025d4: 23 28 de 83  	sw	t4, -2000(t3)
;     a += i0 * b0;
800025d8: 13 1f 33 00  	slli	t5, t1, 3
800025dc: 33 0f e0 41  	neg	t5, t5
;     ssr_config_reg[dm].stride[1].value = i1 - a;
800025e0: 23 2c ee 83  	sw	t5, -1992(t3)
;     a += i1 * b1;
800025e4: 33 07 67 40  	sub	a4, a4, t1
800025e8: 13 17 37 00  	slli	a4, a4, 3
;     ssr_config_reg[dm].stride[2].value = i2 - a;
800025ec: 23 20 ee 84  	sw	a4, -1984(t3)
800025f0: 13 0f 30 00  	addi	t5, zero, 3
;     ssr_config_reg[dm].repeat.value = count - 1;
800025f4: 23 24 ee 81  	sw	t5, -2040(t3)
;     snrt_ssr_loop_4d(SNRT_SSR_DM1, 4, K, M / 4, N, 8, 8 * ldB, 8 * 4, 0);
800025f8: 13 18 38 00  	slli	a6, a6, 3
;     ssr_config_reg[dm].bounds[0].value = b0;
800025fc: 23 28 ee 91  	sw	t5, -1776(t3)
;     ssr_config_reg[dm].bounds[1].value = b1;
80002600: 23 2c 6e 90  	sw	t1, -1768(t3)
;     ssr_config_reg[dm].bounds[2].value = b2;
80002604: 23 20 5e 92  	sw	t0, -1760(t3)
;     ssr_config_reg[dm].bounds[3].value = b3;
80002608: 23 24 7e 92  	sw	t2, -1752(t3)
;     ssr_config_reg[dm].stride[0].value = i0 - a;
8000260c: 23 28 de 93  	sw	t4, -1744(t3)
;     ssr_config_reg[dm].stride[1].value = i1 - a;
80002610: 13 07 88 fe  	addi	a4, a6, -24
80002614: 23 2c ee 92  	sw	a4, -1736(t3)
;     a += i1 * b1;
80002618: 33 08 68 02  	mul	a6, a6, t1
;     ssr_config_reg[dm].stride[2].value = i2 - a;
8000261c: 33 87 0e 41  	sub	a4, t4, a6
80002620: 23 20 ee 94  	sw	a4, -1728(t3)
;     a += i2 * b2;
80002624: 13 97 52 00  	slli	a4, t0, 5
;     ssr_config_reg[dm].stride[3].value = i3 - a;
80002628: 33 08 07 01  	add	a6, a4, a6
8000262c: 13 07 80 fe  	addi	a4, zero, -24
80002630: 33 07 07 41  	sub	a4, a4, a6
80002634: 23 24 ee 94  	sw	a4, -1720(t3)
;     ssr_config_reg[dm].rptr[dim].value = (size_t)ptr;
80002638: 23 28 de 8c  	sw	a3, -1840(t3)
8000263c: 23 2c fe 9c  	sw	a5, -1576(t3)
;     for (uint32_t n = 0; n < N; n++) {
80002640: 93 36 15 00  	seqz	a3, a0
80002644: 13 b7 15 00  	seqz	a4, a1
;     for (uint32_t n = 0; n < N; n++) {
80002648: b3 e6 e6 00  	or	a3, a3, a4
;     __builtin_ssr_enable();
8000264c: 73 e7 00 7c  	csrrsi	a4, 1984, 1
;     for (uint32_t n = 0; n < N; n++) {
80002650: 63 80 06 02  	beqz	a3, 0x80002670 <gemm_seq_ssr+0xd4>
;     __builtin_ssr_disable();
80002654: 73 f5 00 7c  	csrrci	a0, 1984, 1
;     asm volatile("" ::"f"(ft0), "f"(ft1));
80002658: 87 31 81 00  	fld	ft3, 8(sp)
8000265c: 07 32 01 00  	fld	ft4, 0(sp)
80002660: 53 80 31 22  	fmv.d	ft0, ft3
80002664: d3 00 42 22  	fmv.d	ft1, ft4
; }
80002668: 13 01 01 01  	addi	sp, sp, 16
8000266c: 67 80 00 00  	ret
80002670: 03 28 01 01  	lw	a6, 16(sp)
80002674: 13 03 00 00  	mv	t1, zero
80002678: 93 32 16 00  	seqz	t0, a2
8000267c: 6f 00 c0 00  	j	0x80002688 <gemm_seq_ssr+0xec>
;     for (uint32_t n = 0; n < N; n++) {
80002680: 13 03 13 00  	addi	t1, t1, 1
80002684: e3 08 a3 fc  	beq	t1, a0, 0x80002654 <gemm_seq_ssr+0xb8>
;         for (uint32_t m = 0; m < M; m += 4) {
80002688: e3 9c 02 fe  	bnez	t0, 0x80002680 <gemm_seq_ssr+0xe4>
8000268c: 93 06 00 00  	mv	a3, zero
80002690: b3 03 03 03  	mul	t2, t1, a6
;             register double c0 = C[n * ldC + m + 0];
80002694: 33 87 76 00  	add	a4, a3, t2
80002698: 13 17 37 00  	slli	a4, a4, 3
8000269c: 33 87 e8 00  	add	a4, a7, a4
800026a0: 87 31 07 00  	fld	ft3, 0(a4)
;             register double c1 = C[n * ldC + m + 1];
800026a4: 07 32 87 00  	fld	ft4, 8(a4)
;             register double c2 = C[n * ldC + m + 2];
800026a8: 07 33 07 01  	fld	ft6, 16(a4)
;             register double c3 = C[n * ldC + m + 3];
800026ac: 87 32 87 01  	fld	ft5, 24(a4)
;             register double c1 = C[n * ldC + m + 1];
800026b0: 13 0f 87 00  	addi	t5, a4, 8
;             register double c2 = C[n * ldC + m + 2];
800026b4: 93 0e 07 01  	addi	t4, a4, 16
;             register double c3 = C[n * ldC + m + 3];
800026b8: 13 0e 87 01  	addi	t3, a4, 24
800026bc: 93 07 06 00  	mv	a5, a2
;             for (uint32_t k = 0; k < K; k++) {
800026c0: 93 87 f7 ff  	addi	a5, a5, -1
;                 asm volatile(
800026c4: c3 71 10 1a  	fmadd.d	ft3, ft0, ft1, ft3
800026c8: 43 72 10 22  	fmadd.d	ft4, ft0, ft1, ft4
800026cc: 43 73 10 32  	fmadd.d	ft6, ft0, ft1, ft6
800026d0: c3 72 10 2a  	fmadd.d	ft5, ft0, ft1, ft5
;             for (uint32_t k = 0; k < K; k++) {
800026d4: e3 96 07 fe  	bnez	a5, 0x800026c0 <gemm_seq_ssr+0x124>
;             C[n * ldC + m + 0] = c0;
800026d8: 27 30 37 00  	fsd	ft3, 0(a4)
;             C[n * ldC + m + 1] = c1;
800026dc: 27 30 4f 00  	fsd	ft4, 0(t5)
;             C[n * ldC + m + 2] = c2;
800026e0: 27 b0 6e 00  	fsd	ft6, 0(t4)
;         for (uint32_t m = 0; m < M; m += 4) {
800026e4: 93 86 46 00  	addi	a3, a3, 4
;             C[n * ldC + m + 3] = c3;
800026e8: 27 30 5e 00  	fsd	ft5, 0(t3)
;         for (uint32_t m = 0; m < M; m += 4) {
800026ec: e3 e4 b6 fa  	bltu	a3, a1, 0x80002694 <gemm_seq_ssr+0xf8>
800026f0: 6f f0 1f f9  	j	0x80002680 <gemm_seq_ssr+0xe4>

800026f4 <__snrt_isr>:
;     uint32_t cause = read_csr(mcause);
800026f4: 73 25 20 34  	csrr	a0, mcause
;     if (cause & MCAUSE_INTERRUPT) {
800026f8: 63 44 05 00  	bltz	a0, 0x80002700 <__snrt_isr+0xc>
;         while (1)
800026fc: 6f 00 00 00  	j	0x800026fc <__snrt_isr+0x8>
80002700: b7 05 00 80  	lui	a1, 524288
80002704: 93 85 f5 ff  	addi	a1, a1, -1
;         switch (cause & ~MCAUSE_INTERRUPT) {
80002708: 33 75 b5 00  	and	a0, a0, a1
8000270c: 13 05 d5 ff  	addi	a0, a0, -3
80002710: 93 55 25 00  	srli	a1, a0, 2
80002714: 13 15 e5 01  	slli	a0, a0, 30
80002718: 33 65 b5 00  	or	a0, a0, a1
8000271c: 93 05 40 00  	addi	a1, zero, 4
80002720: 63 0a b5 06  	beq	a0, a1, 0x80002794 <.LBB1_7+0x58>
80002724: 63 1a 05 08  	bnez	a0, 0x800027b8 <.LBB1_7+0x7c>
80002728: 37 05 00 00  	lui	a0, 0
8000272c: 33 05 45 00  	add	a0, a0, tp
80002730: 03 25 05 00  	lw	a0, 0(a0)
80002734: 03 25 05 00  	lw	a0, 0(a0)
80002738: f3 25 40 f1  	csrr	a1, mhartid

8000273c <.LBB1_7>:
;     asm volatile(
8000273c: 17 16 00 00  	auipc	a2, 1
80002740: 13 06 46 9e  	addi	a2, a2, -1564
80002744: 03 25 85 00  	lw	a0, 8(a0)
;     asm volatile(
80002748: 93 06 06 00  	mv	a3, a2
8000274c: 93 02 10 00  	addi	t0, zero, 1
80002750: af a2 56 0c  	amoswap.w.aq	t0, t0, (a3)
80002754: e3 9e 02 fe  	bnez	t0, 0x80002750 <.LBB1_7+0x14>
;     *(clint_p + ((hartid & ~0x1f) >> 5)) &= ~(1 << (hartid & 0x1f));
80002758: b7 06 00 00  	lui	a3, 0
8000275c: b3 86 46 00  	add	a3, a3, tp
80002760: 83 a6 86 00  	lw	a3, 8(a3)
80002764: 33 85 a5 40  	sub	a0, a1, a0
80002768: 93 55 35 00  	srli	a1, a0, 3
8000276c: 93 f5 c5 ff  	andi	a1, a1, -4
80002770: b3 85 b6 00  	add	a1, a3, a1
80002774: 83 a6 05 00  	lw	a3, 0(a1)
80002778: 13 07 10 00  	addi	a4, zero, 1
8000277c: 33 15 a7 00  	sll	a0, a4, a0
80002780: 13 45 f5 ff  	not	a0, a0
80002784: 33 f5 a6 00  	and	a0, a3, a0
80002788: 23 a0 a5 00  	sw	a0, 0(a1)
;     asm volatile("amoswap.w.rl  x0,x0,(%0)   # Release lock by storing 0\n"
8000278c: 2f 20 06 0a  	amoswap.w.rl	zero, zero, (a2)
; }
80002790: 67 80 00 00  	ret
; uint32_t snrt_cluster_core_idx() { return _snrt_core_idx; }
80002794: 37 05 00 00  	lui	a0, 0
80002798: 33 05 45 00  	add	a0, a0, tp
8000279c: 03 25 45 00  	lw	a0, 4(a0)
; void snrt_int_cluster_clr(uint32_t mask) { cl_clint_clr(mask); }
800027a0: b7 05 00 00  	lui	a1, 0
800027a4: b3 85 45 00  	add	a1, a1, tp
800027a8: 83 a5 c5 00  	lw	a1, 12(a1)
800027ac: 13 06 10 00  	addi	a2, zero, 1
;     snrt_int_cluster_clr(1 << cluster_core_idx);
800027b0: 33 15 a6 00  	sll	a0, a2, a0
; void snrt_int_cluster_clr(uint32_t mask) { cl_clint_clr(mask); }
800027b4: 23 a4 a5 00  	sw	a0, 8(a1)
; }
800027b8: 67 80 00 00  	ret

800027bc <_snrt_init_team>:
;     team->base.root = team;
800027bc: 23 a0 f7 00  	sw	a5, 0(a5)
;     team->bootdata = (void *)bootdata;
800027c0: 23 a2 e7 00  	sw	a4, 4(a5)
;     team->global_core_base_hartid = bootdata->hartid_base;
800027c4: 03 23 87 00  	lw	t1, 8(a4)
800027c8: 23 a4 67 00  	sw	t1, 8(a5)
;     team->global_core_num = bootdata->core_count * bootdata->cluster_count *
800027cc: 03 28 87 02  	lw	a6, 40(a4)
;                             bootdata->s1_quadrant_count;
800027d0: 83 28 c7 02  	lw	a7, 44(a4)
;     team->global_core_num = bootdata->core_count * bootdata->cluster_count *
800027d4: 83 22 47 00  	lw	t0, 4(a4)
800027d8: 33 88 08 03  	mul	a6, a7, a6
800027dc: 33 05 58 02  	mul	a0, a6, t0
800027e0: 23 a6 a7 00  	sw	a0, 12(a5)
;     asm("csrr %0, mhartid" : "=r"(hartid));
800027e4: f3 28 40 f1  	csrr	a7, mhartid
;         (snrt_hartid() - bootdata->hartid_base) / bootdata->core_count;
800027e8: 33 85 68 40  	sub	a0, a7, t1
800027ec: 33 55 55 02  	divu	a0, a0, t0
;     team->cluster_idx =
800027f0: 23 a8 a7 00  	sw	a0, 16(a5)
;     team->cluster_num = bootdata->cluster_count * bootdata->s1_quadrant_count;
800027f4: 23 aa 07 01  	sw	a6, 20(a5)
;     team->cluster_core_base_hartid = bootdata->hartid_base;
800027f8: 23 ac 67 00  	sw	t1, 24(a5)
;     team->cluster_core_num = cluster_core_num;
800027fc: 23 ae b7 00  	sw	a1, 28(a5)
;         (uint64_t)(bootdata->global_mem_start + _snrt_cluster_global_offset);
80002800: 03 25 87 01  	lw	a0, 24(a4)
80002804: b7 05 00 10  	lui	a1, 65536
80002808: 33 05 b5 00  	add	a0, a0, a1
;     team->global_mem.start =
8000280c: 23 a2 07 02  	sw	zero, 36(a5)
80002810: 23 a0 a7 02  	sw	a0, 32(a5)
;     team->global_mem.end = (uint64_t)bootdata->global_mem_end;
80002814: 03 25 07 02  	lw	a0, 32(a4)
80002818: 83 25 47 02  	lw	a1, 36(a4)
8000281c: 23 a4 a7 02  	sw	a0, 40(a5)
80002820: 23 a6 b7 02  	sw	a1, 44(a5)
;     team->cluster_mem.start = (uint64_t)spm_start;
80002824: 23 a8 c7 02  	sw	a2, 48(a5)
80002828: 23 aa 07 02  	sw	zero, 52(a5)
;     team->cluster_mem.end = (uint64_t)spm_end;
8000282c: 23 ac d7 02  	sw	a3, 56(a5)
80002830: 23 ae 07 02  	sw	zero, 60(a5)
;     team->barrier_reg_ptr = (uint32_t)spm_start + bootdata->tcdm_size +
80002834: 03 25 07 01  	lw	a0, 16(a4)
80002838: 33 08 a6 00  	add	a6, a2, a0
8000283c: 93 05 08 04  	addi	a1, a6, 64
80002840: 23 a8 b7 06  	sw	a1, 112(a5)
;         (uint64_t)spm_start + bootdata->tcdm_size + bootdata->tcdm_size / 2;
80002844: b3 32 a8 00  	sltu	t0, a6, a0
80002848: 93 55 15 00  	srli	a1, a0, 1
8000284c: 33 03 b8 00  	add	t1, a6, a1
80002850: b3 35 03 01  	sltu	a1, t1, a6
80002854: b3 85 b2 00  	add	a1, t0, a1
;     team->zero_mem.start =
80002858: 23 a0 67 04  	sw	t1, 64(a5)
8000285c: 23 a2 b7 04  	sw	a1, 68(a5)
;     team->zero_mem.end = (uint64_t)spm_start + 2 * bootdata->tcdm_size;
80002860: 13 15 15 00  	slli	a0, a0, 1
80002864: b3 05 c5 00  	add	a1, a0, a2
80002868: 33 b5 a5 00  	sltu	a0, a1, a0
8000286c: 23 a4 b7 04  	sw	a1, 72(a5)
80002870: 23 a6 a7 04  	sw	a0, 76(a5)
;     team->cluster_barrier.barrier = 0;
80002874: 23 a4 07 06  	sw	zero, 104(a5)
;     team->cluster_barrier.barrier_iteration = 0;
80002878: 23 a6 07 06  	sw	zero, 108(a5)
;     _snrt_team_current = &team->base;
8000287c: 37 05 00 00  	lui	a0, 0
80002880: 33 05 45 00  	add	a0, a0, tp
80002884: 23 20 f5 00  	sw	a5, 0(a0)
;         (snrt_hartid() - _snrt_team_current->root->cluster_core_base_hartid) %
80002888: 03 a5 07 00  	lw	a0, 0(a5)
8000288c: 83 25 85 01  	lw	a1, 24(a0)
;         _snrt_team_current->root->cluster_core_num;
80002890: 03 25 c5 01  	lw	a0, 28(a0)
;         (snrt_hartid() - _snrt_team_current->root->cluster_core_base_hartid) %
80002894: b3 85 b8 40  	sub	a1, a7, a1
80002898: 33 f5 a5 02  	remu	a0, a1, a0
;     _snrt_core_idx =
8000289c: b7 05 00 00  	lui	a1, 0
800028a0: b3 85 45 00  	add	a1, a1, tp
800028a4: 23 a2 a5 00  	sw	a0, 4(a1)
800028a8: 13 05 80 44  	addi	a0, zero, 1096
;     putc_buffer[snrt_hartid()].hdr.size = 0;
800028ac: 33 85 a8 02  	mul	a0, a7, a0

800028b0 <.LBB0_1>:
800028b0: 97 15 00 00  	auipc	a1, 1
800028b4: 93 85 45 87  	addi	a1, a1, -1932
800028b8: 33 05 b5 00  	add	a0, a0, a1
800028bc: 23 20 05 00  	sw	zero, 0(a0)
;     team->peripherals.clint = (uint32_t *)bootdata->clint_base;
800028c0: 83 28 07 03  	lw	a7, 48(a4)
800028c4: 23 aa 17 07  	sw	a7, 116(a5)
;     team->peripherals.perf_counters =
800028c8: 23 ae 07 07  	sw	a6, 124(a5)
;     team->peripherals.wakeup = (uint32_t *)0;  // not supported in RTL anymore
800028cc: 23 ac 07 06  	sw	zero, 120(a5)
;         (uint32_t *)(spm_start + bootdata->tcdm_size +
800028d0: 13 07 08 03  	addi	a4, a6, 48
;     team->peripherals.cl_clint =
800028d4: 23 a0 e7 08  	sw	a4, 128(a5)
;         ALIGN_UP((uint32_t)team->cluster_mem.start, MIN_CHUNK_SIZE);
800028d8: 13 05 76 00  	addi	a0, a2, 7
800028dc: 13 75 85 ff  	andi	a0, a0, -8
;     team->allocator.l1.base =
800028e0: 23 a8 a7 04  	sw	a0, 80(a5)
;         (uint32_t)(team->cluster_mem.end - team->cluster_mem.start);
800028e4: 33 86 c6 40  	sub	a2, a3, a2
;     team->allocator.l1.size =
800028e8: 23 aa c7 04  	sw	a2, 84(a5)
;     team->allocator.l1.next = team->allocator.l1.base;
800028ec: 23 ac a7 04  	sw	a0, 88(a5)
;         ALIGN_UP((uint32_t)_edram + l3off, MIN_CHUNK_SIZE);
800028f0: 03 a5 05 00  	lw	a0, 0(a1)
800028f4: 13 05 f5 44  	addi	a0, a0, 1103
800028f8: 13 75 85 ff  	andi	a0, a0, -8
;     team->allocator.l3.base =
800028fc: 23 ae a7 04  	sw	a0, 92(a5)
;     team->allocator.l3.size = 0;
80002900: 23 a0 07 06  	sw	zero, 96(a5)
;     team->allocator.l3.next = team->allocator.l3.base;
80002904: 23 a2 a7 06  	sw	a0, 100(a5)
;     clint_p = team->peripherals.clint;
80002908: 37 05 00 00  	lui	a0, 0
8000290c: 33 05 45 00  	add	a0, a0, tp
80002910: 23 24 15 01  	sw	a7, 8(a0)
;     cl_clint_p = team->peripherals.cl_clint;
80002914: 37 05 00 00  	lui	a0, 0
80002918: 33 05 45 00  	add	a0, a0, tp
8000291c: 23 26 e5 00  	sw	a4, 12(a0)
; }
...
80002934: 93 81 01 f2  	addi	gp, gp, -224
...
80002968: 93 82 c2 7b  	addi	t0, t0, 1980

8000296c <.Lpcrel_hi1>:
;     la        t1, _end
8000296c: 17 03 00 00  	auipc	t1, 0
80002970: 13 03 83 7b  	addi	t1, t1, 1976
;     bge       t0, t1, 2f
...
80002a1c: 83 a2 82 40  	lw	t0, 1032(t0)
;     sub       a3, a3, t0
...
80002a2c: 83 a3 c3 3f  	lw	t2, 1020(t2)
...
80002a54: 93 82 02 60  	addi	t0, t0, 1536

80002a58 <.Lpcrel_hi5>:
;     la        t1, __tdata_end
80002a58: 17 03 00 00  	auipc	t1, 0
80002a5c: 13 03 83 5f  	addi	t1, t1, 1528

80002a60 <.Lpcrel_hi6>:
;     la        t2, __tbss_start
80002a60: 97 03 00 00  	auipc	t2, 0
80002a64: 93 83 03 5f  	addi	t2, t2, 1520

80002a68 <.Lpcrel_hi7>:
;     la        t3, __tbss_end
80002a68: 17 0e 00 00  	auipc	t3, 0
80002a6c: 13 0e 8e 5f  	addi	t3, t3, 1528
...
80002aac: 93 82 82 5a  	addi	t0, t0, 1448

80002ab0 <.Lpcrel_hi9>:
;     la        t1, __tbss_end
80002ab0: 17 03 00 00  	auipc	t1, 0
80002ab4: 13 03 03 5b  	addi	t1, t1, 1456
;     bge       t0, t1, 2f
...
80002ae8: e7 80 80 cd  	jalr	-808(ra)
;     lw        a0, 0(sp)
...
80002c1c: e7 80 c0 ad  	jalr	-1316(ra)
;     csrr    t0, misa
...
80002d38: 97 f0 ff ff  	auipc	ra, 1048575
80002d3c: e7 80 00 58  	jalr	1408(ra)
;     lw        a0, 0(a0)
...
80002d68: 97 f0 ff ff  	auipc	ra, 1048575
80002d6c: e7 80 00 53  	jalr	1328(ra)
;     lw        t0, 0(sp)
...
;     la        t1, scratch_reg
80002d88: 17 d3 ff 81  	auipc	t1, 532477
80002d8c: 13 03 c3 28  	addi	t1, t1, 652
;     sw        t0, 0(t1)
